...
def test_strict_5tb_service_keeps_secret_env_file() -> None:
    ...
    assert "Environment=V5_MEMO_FULL_RAW_SHARD_LOCAL_CACHE_MAX_BYTES=8589934592" in config.read_text()
    ...
    assert "V5_MEMO_FULL_RAW_SHARD_LOCAL_CACHE_MAX_BYTES=8589934592" in env_example
