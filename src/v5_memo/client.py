...
class FullRawCorpusSearchClient:
    ...
    def from_env(cls, *, strict: bool = False) -> FullRawCorpusSearchClient:
        ...
        return cls(
            ...
            sweep_wait_seconds=min(_float_env("V5_MEMO_FULL_RAW_FOREGROUND_SWEEP_WAIT_SECONDS", 0.0), 900.0),
    ...
    def _search_variant(self, search_pass: FullRawSearchPass, *, limit: int) -> list[CorpusHit]:
        ...
        can_wait_for_sweep = initial_error is not None or sweep_status in {"busy", "miss", "queued", "running"}
